...
/**
 * PIXIQ — Minimal Luxury Landing Page
 * Tech: React + TailwindCSS + Framer Motion
 * Notes:
 *  - HERO_IMAGE now set to neon pool night image.
 *  - Added pixiq white logo to header + footer.
 *  - Added simplified monogram icon for favicon use.
 *  - Social links updated to provided SoundCloud, X, Instagram.
 *  - All branding uses lowercase `pixiq`.
 */

const HERO_IMAGE =
  "/mnt/data/20250714_2015_Neon Pool Night_simple_compose_01k05px2weftrt4b1g0q22bc8s.png"; // neon pool night image as hero

const LOGO_IMAGE = "/mnt/data/pixiqwhitelogo.png"; // pixiq white logo
// Simplified monogram icon (placeholder path, replace with real SVG/PNG for favicon)
const ICON_IMAGE = "/mnt/data/pixiqmonogram.png";

const AUDIO_SETS = [
  {
    title: "bait & switch mashups",
    description: "unexpected blends, luxury chaos, clean transitions",
    audioSrc: "https://your-cdn.example.com/pixiq/audio/bait-switch.mp3",
  },
  {
    title: "minimal techno rituals",
    description: "hypnotic, restrained, atmospheric power",
    audioSrc: "https://your-cdn.example.com/pixiq/audio/minimal-techno.mp3",
  },
  {
    title: "drum & bass seduction",
    description: "silky rollers, late-night intensity",
    audioSrc: "https://your-cdn.example.com/pixiq/audio/dnb-seduction.mp3",
  },
  {
    title: "dance energy flow",
    description: "euphoric movement, sweat, glow",
    audioSrc: "https://your-cdn.example.com/pixiq/audio/dance-energy.mp3",
  },
];
...
export default function PixiqLanding() {
  ...
  return (
    <div className="min-h-screen w-full bg-black text-white">
      {/* SITE ICON */}
      <link rel="icon" href={ICON_IMAGE} type="image/png" />
        ...
        <div className="relative z-10 h-full container mx-auto px-6 flex items-end pb-16">
          ...
          >
            <div className="uppercase tracking-[0.35em] text-xs text-white/70 mb-3">
              sonic oracle · faceless allure
            </div>
            <h1 className="text-5xl md:text-7xl font-semibold leading-[0.95] mb-4">
              pixiq
            </h1>
            <p className="text-white/80 max-w-xl">
              minimal luxury. cinematic energy. curated disorientation.
            </p>
      ...
      {/* EXPERIENCE SHORT */}
      <section className="px-6 py-16 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.06),rgba(0,0,0,0)_65%)]">
        <div className="container mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h3 className="text-2xl md:text-3xl font-semibold mb-3">the experience</h3>
            <p className="text-white/70 leading-relaxed">
              pixiq isn’t background noise — she is an atmosphere. a faceless
              oracle of rhythm, shifting bodies and moods with a single drop.
              private lounges, rooftop rain, poolside smoke — minimal luxury with
              maximal pull.
            </p>
          </div>
